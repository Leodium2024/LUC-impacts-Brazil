...
### The SDMs are calibrated and validated in this script
### Input = excel files containing environemental values for each species occurence and absence location
### Output = excel files containing calibartaion coeficient and another one containing the performance indicators
